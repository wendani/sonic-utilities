...
STATS_DESCRIPTION = [
    ...
    ('RX OK/DROP',              'PFC_WD_PG_STATS_RX_PACKETS',           'PFC_WD_PG_STATS_RX_DROPPED_PACKETS'),
    ('TX LAST OK/DROP',         'PFC_WD_QUEUE_STATS_TX_PACKETS_LAST',   'PFC_WD_QUEUE_STATS_TX_DROPPED_PACKETS_LAST'),
    ('RX LAST OK/DROP',         'PFC_WD_PG_STATS_RX_PACKETS_LAST',      'PFC_WD_PG_STATS_RX_DROPPED_PACKETS_LAST'),
]
